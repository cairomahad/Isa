...
### URLs и Preview:
- **Frontend Preview**: `https://learning-app-test.preview.emergentagent.com`
...
```bash
EXPO_PUBLIC_BACKEND_URL=https://learning-app-test.preview.emergentagent.com
...
1. **Открыть в браузере**: `https://learning-app-test.preview.emergentagent.com`

...
### URLs и Preview:
- **Frontend Preview**: `https://prayer-notify-fix.preview.emergentagent.com`
...
```bash
EXPO_PUBLIC_BACKEND_URL=https://prayer-notify-fix.preview.emergentagent.com
...
1. **Открыть в браузере**: `https://prayer-notify-fix.preview.emergentagent.com`

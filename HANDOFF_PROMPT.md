...
### URLs и Preview:
- **Frontend Preview**: `https://islamic-app-bugs.preview.emergentagent.com`
...
```bash
EXPO_PUBLIC_BACKEND_URL=https://islamic-app-bugs.preview.emergentagent.com
...
1. **Открыть в браузере**: `https://islamic-app-bugs.preview.emergentagent.com`

#!/usr/bin/env python3
"""
Check Quran tables structure in Supabase
"""
...
def main():
    ...
    quran_tables = ['quran_program', 'quran_progress', 'quran_reviews']
    
    for table_name in quran_tables:
        print(f"\n📋 Table: {table_name}")
        print("=" * 60)
        ...
        try:
            ...
            if response.data and len(response.data) > 0:
                ...
                print("  (No records found - table may be empty)")
